# grok x rooms
This project connects to xAI's Grok model via API and asks it the one question on every run. Each answer is auto-posted to a dedicated X (Twitter) account. No human intervention. No editing. No filters.

what is grok x rooms?
